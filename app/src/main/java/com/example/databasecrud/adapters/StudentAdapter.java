package com.example.databasecrud.adapters;
...
import com.example.databasecrud.DbHelper;
import com.example.databasecrud.DisplayStudentsActivity;
import com.example.databasecrud.EditDetailsActivity;
...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.StudentViewHolder>{
    ...
    public StudentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recylerview_students, parent, false);
